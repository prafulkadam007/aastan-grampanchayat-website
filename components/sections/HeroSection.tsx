        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-10 items-center">
          <div className="order-2 md:order-1 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center md:justify-start">
              <Link
                href="/members"
                className="bg-[var(--color-accent-strong)] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[var(--color-accent-hover)] transition inline-flex items-center justify-center gap-2 touch-target shadow-lg shadow-[rgba(194,65,12,0.25)]"
              >
                {t('meetTeam')}
              ...
              <Link
                href="/works"
                className="bg-[var(--color-card)] text-[var(--color-primary)] px-6 py-3 rounded-lg font-semibold hover:bg-[var(--color-primary-soft)] transition border-2 border-[var(--color-primary)] inline-flex items-center justify-center touch-target shadow-sm"
              >
                {t('viewWork')}
              </Link>
            </div>
          </div>
          <div className="relative h-56 sm:h-72 md:h-96 rounded-2xl overflow-hidden shadow-xl order-1 md:order-2 ring-1 ring-[var(--color-border)]">
            <Image
